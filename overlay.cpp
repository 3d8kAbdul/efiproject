...
const void c_overlay::render(FLOAT width, FLOAT height) {
	...
	// imgui menu itself
	ImGui::Begin("Misc", 0, ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize | ImGuiInputTextFlags_NoHorizontalScroll | ImGuiWindowFlags_NoScrollbar);
	ImGui::Text("Overlay");
	//ImGui::Checkbox("Enable Crosshair", &l_crosshair);
	//ImGui::Checkbox("Enable FPS Counter", &l_show_fps);
	ImGui::End();

		ImGui::Begin("base", 0, ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoTitleBar  | ImGuiInputTextFlags_NoHorizontalScroll | ImGuiWindowFlags_NoScrollbar);
		ImGui::Text("Base Address : 0x7ff727110000");
		ImGui::Text("Process Name : Dayz_x64.exe");
		ImGui::End();
}
